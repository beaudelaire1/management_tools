...
- Services: `queue_notification` (idempotent on replay), `deliver_notification` (adapter port, retry cap, failures visible and retryable, no double send), `activate_template`, `render_template`.
